...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        get_user_object: function get_user_object() {
            var _this = this;

            Nova.request().get('/nova-vendor/username-tool/get_current_user').then(function (response) {
                // handle success
                if (response.data) {
                    _this.user_object = response.data;
                }
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Username Tool")]),
      _vm._v(" "),
      _c("card", {
      ...
      _vm.user_object
        ? _c(
            ...
            [
              _c("center", [
                _vm._v(
                  " \n            ID: " + _vm._s(_vm.user_object.id) + " "
                ),
                _c("br"),
                _vm._v(
                  "\n            Name: " + _vm._s(_vm.user_object.name) + " "
                ),
                _c("br"),
                _vm._v(
                  "\n            Email: " + _vm._s(_vm.user_object.email) + " "
                ),
                _c("br")
              ])
            ],
